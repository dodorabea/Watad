    ...
    var o = function () {
        ...
        return n(e, [{
            ...
            value: function (e, t, s) {
                if (this.target = "string" == typeof e ? e : e.dataset.target || e.href, -1 !== this.target.indexOf("#") && (this.target = this.target.split("#")[1]), this.target) {
                    var n = this;
                    this.sidebar = document.getElementById(n.target), this.button = e, this.settings = Object.assign(n.settings, t), document.body.classList.contains(n.classes.body) && !n.sidebar.classList.contains("open") && this.close(s, !0), s && "function" == typeof s && s(n)
                }
            }
        }, {
            key: "open",
    ...
    var d = function () {
        function e(s, n) {
            t(this, e), this.settings = Object.assign({
                ...
                SM: "vg-nav-sm",
                XS: "vg-nav-xs"
            }, this.current_responsive_size = "", this.isInit = !1, this.isInit || this.init(this.callback)
        }
        return n(e, [{
            key: "init",
            value: function (e) {
                ...
                var r = s.classList.contains(t.classes.XXL) || s.classList.contains(t.classes.XL) || s.classList.contains(t.classes.LG) || s.classList.contains(t.classes.MD) || s.classList.contains(t.classes.SM) || s.classList.contains(t.classes.XS);
                if (r) {
                    var c = "",
                        l = '<span class="' + t.classes.hamburger + '--lines"><span></span><span></span><span></span></span>';
                    t.settings.mobileTitle && (c = '<span class="' + t.classes.hamburger + '--title">' + t.settings.mobileTitle + "</span>"), null !== t.settings.hamburger && (l = t.settings.hamburger), s.insertAdjacentHTML("afterbegin", '<a href="#" class="' + t.classes.hamburger + '">' + c + l + "</a>")
                }
                var d = document.getElementById(t.sidebar),
                    u = t.settings.sidebar || !1,
                    h = u.placement || "right",
                    v = u.hash ? 'data-hash="true"' : "";
                if (r)
                    if (d) {
                        if ("clone" in u && u.clone) {
                            var p = document.querySelector("." + t.classes.sidebar).querySelectorAll(u.clone);
                            p && t.cloneNavigation(p, s.querySelector("." + t.classes.container))
                        }
                    } else {
                        var f = "";
                        t.settings.mobileTitle && (f = '<span class="' + t.classes.sidebar + '-title">' + t.settings.mobileTitle + "</span>"), document.body.insertAdjacentHTML("beforeend", '<div class="' + t.classes.sidebar + " " + h + '" id="' + t.sidebar + '" ' + v + '><div class="vg-sidebar-content"><div class="vg-sidebar-header">' + f + '<div class="' + t.classes.sidebar + '-close" data-dismiss="' + t.classes.sidebar + '">&times;</div></div><div class="vg-sidebar-body"></div></div></div>');
                        var g = document.getElementsByClassName(t.classes.sidebar + "-body");
                        t.cloneNavigation(g, s.querySelector("." + t.classes.container))
                    } if (t.settings.move && r) {
                    var m = s.clientWidth,
                        b = s.querySelectorAll(".vg-nav-wrapper > li");
                    if (b.length) {
                        var y, w = 0,
                            k = [],
                            L = a(b);
                        try {
                            for (L.s(); !(y = L.n()).done;) {
                                var x = y.value;
                                (w += x.clientWidth) >= m && (k.push(x), x.remove())
                            }
                        } catch (e) {
                            L.e(e)
                        } finally {
                        ...
                        if (w >= m) {
                            var S = s.querySelectorAll(".vg-nav-wrapper > li");
                            k.unshift(S[S.length - 1]), S[S.length - 1].remove();
                            var q = s.querySelector(".vg-nav-wrapper");
                            if (q) {
                                ...
                                q.insertAdjacentHTML("beforeend", '<li class="dropdown dots"><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-three-dots-vertical" viewBox="0 0 16 16"><path d="M9.5 13a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0zm0-5a1.5 1.5 0 1 1-3 0 1.5 1.5 0 0 1 3 0z"/></svg></a></li>'), q.querySelector(".dots").appendChild(j)
                            }
                        }
                    }
                }
                this.isInit = !0, this.toggle(this.callback)
            }
        }, {
            key: "toggle",
            value: function (e) {
                ...
                var t = this,
                    ...
                    i = document.querySelectorAll("." + t.classes.container + " li > a"),
                    a = s.querySelector("." + t.classes.hamburger),
                    r = document.querySelector('[data-dismiss="vg-nav"]');

                function c(e, t, s) {
                    e && "afterClick" in e && "function" == typeof e.afterClick && e.afterClick(t, s)
                }
                e && "afterInit" in e && "function" == typeof e.afterInit && e.afterInit(t), t.clickable() && i.forEach((function (s) {
                    s.onclick = function (s) {
                        var i = this,
                            a = i.closest("li");
                        if (function (e, t, s) {
                                e && "beforeClick" in e && "function" == typeof e.beforeClick && e.beforeClick(t, s)
                            }(e, t, s), a.classList.contains("dropdown")) {
                            if (t.dispose(n, "dropdown-mega"), a.closest("ul").classList.contains(t.classes.container)) return a.classList.contains("show") ? a.classList.remove("show") : (t.dispose(n), a.classList.add("show")), c(e, t, s), !1;
                            if (a.classList.contains("show")) return i.closest("li").classList.remove("show"), t.dispose(a), c(e, t, s), !1;
                            for (var o = a.children, r = 1; r <= o.length; r++) o[r - 1].tagName;
                            if (o.length > 0) return i.closest("li").classList.add("show"), c(e, t, s), !1
                        }
                        if (a.classList.contains("dropdown-mega")) return a.classList.contains("show") ? a.classList.remove("show") : (t.dispose(n), a.classList.add("show")), c(e, t, s), !1;
                        c(e, t, s)
                    }
                })), window.addEventListener("mouseup", (function (e) {
                    e.target.closest("." + t.classes.container) || (t.dispose(n), t.dispose(n, "dropdown-mega"))
                })), r && (r.onclick = function () {
                    return t.dispose(n), t.dispose(n, "dropdown-mega"), !1
                }), a.onclick = function () {
                    var e = this,
                        s = t.sidebar,
                        n = {
                            hash: t.settings.sidebar.hash
                        };
                    return new o(s, n).open({
                        beforeOpen: function () {
